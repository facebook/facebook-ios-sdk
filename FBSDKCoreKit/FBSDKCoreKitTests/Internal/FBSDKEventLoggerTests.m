...
@interface FBSDKEventLoggerTests : FBSDKTestCase
@end

@implementation FBSDKEventLoggerTests

- (void)testLoggingEventDelegatesToAppEvents
{
  FBSDKEventLogger *logger = [FBSDKEventLogger new];
  [logger logInternalEvent:self.name isImplicitlyLogged:YES];
