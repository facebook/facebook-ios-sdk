...
enum SampleRawLoginResponse {
  ...
  static let grantedScopes = "public_profile,user_avatar"
  static let deniedScopes = "user_avatar"
  static let requestedPermissions: Set<Permission> = [.publicProfile, .userAvatar]
  static let declinedPermissions: Set<Permission> = [.userAvatar]
