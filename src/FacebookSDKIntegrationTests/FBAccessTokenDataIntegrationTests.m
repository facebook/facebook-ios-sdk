...
- (KVOHelper *)initWithBlock:(kvo_handler_block)handler;
...
@interface FBAccessTokenDataIntegrationTests : FBIntegrationTests
@end

@implementation FBAccessTokenDataIntegrationTests
