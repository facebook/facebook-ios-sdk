...
- (void)testCreatingWithMethodNameAndParameters
{
  ...
  XCTAssertTrue([[actual objectForKey:@"parameters"] isEqualToDictionary:@{@"animated": @YES}],
...
- (void)testDecodingEntryWithMethodNameAndParameters
{
  TestCoder *coder = [TestCoder new];
  ...
  XCTAssertEqualObjects(coder.decodedObject[@"parameters"], [NSDictionary class],
                        @"Initializing from a decoder should attempt to decode a dictionary for the parameters key");
}
