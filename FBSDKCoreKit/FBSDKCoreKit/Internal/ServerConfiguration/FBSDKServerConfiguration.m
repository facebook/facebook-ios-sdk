           ...
           migratedAutoLogValues:(NSDictionary<NSString *, id> *) migratedAutoLogValues
{
  if ((self = [super init])) {
    ...
    _defaultShareMode = [defaultShareMode copy];
    ...
    _eventBindings = [eventBindings copy];
    _restrictiveParams = [restrictiveParams copy];
    _AAMRules = [AAMRules copy];
    _suggestedEventsSetting = [suggestedEventsSetting copy];
    _version = FBSDKServerConfigurationVersion;
    _protectedModeRules = [protectedModeRules copy];
