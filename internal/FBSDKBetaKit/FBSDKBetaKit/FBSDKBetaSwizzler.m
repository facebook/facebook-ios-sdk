...
#define FB_FIND_SWIZZLE \
  FBSDKBetaSwizzlingOnClass *swizzlingOnClass = fb_findSwizzle(self, _cmd); \
  FBSDKBetaSwizzle *swizzle = swizzlingOnClass.bindingSwizzle;

#define FB_REMOVE_SELECTOR \
  [FBSDKBetaSwizzler object:self ofClass:swizzlingOnClass.bindingClass removeSelector:_cmd];

@interface FBSDKBetaSwizzle : NSObject
...
@interface FBSDKBetaSwizzlingOnClass : NSObject

@property (nonatomic) FBSDKBetaSwizzle *bindingSwizzle;
@property (nonatomic) Class bindingClass;

- (instancetype)initWithSwizzle:(FBSDKBetaSwizzle *)aSwizzle
                          class:(Class)aClass;

@end

@interface FBSDKBetaSwizzler ()
...
static FBSDKBetaSwizzlingOnClass *fb_findSwizzle(id self, SEL _cmd)
{
  Method aMethod = class_getInstanceMethod([self class], _cmd);
  Class this_class = [self class];
  FBSDKBetaSwizzle *swizzle = nil;

  if (![FBSDKBetaSwizzler object:self ofClass:this_class isCallingSelector:_cmd]) {
    swizzle = (FBSDKBetaSwizzle *)[swizzles objectForKey:MAPTABLE_ID(aMethod)];
  }
  ...
  if (swizzle) {
    [FBSDKBetaSwizzler object:self ofClass:this_class addSelector:_cmd];
  }
  FBSDKBetaSwizzlingOnClass *swizzlingOnClass = [[FBSDKBetaSwizzlingOnClass alloc] initWithSwizzle:swizzle
                                                                                             class:this_class];
...
@implementation FBSDKBetaSwizzler
...
+ (void)initialize
{
  ...
  [FBSDKBetaSwizzler resolveConflict];
}
...
+ (void)printSwizzles
{
  ...
  FBSDKBetaSwizzle *swizzle;
  while ((swizzle = (FBSDKBetaSwizzle *)[en nextObject])) {
    NSLog(@"%@", swizzle);
  }
}

+ (FBSDKBetaSwizzle *)swizzleForMethod:(Method)aMethod
{
  return (FBSDKBetaSwizzle *)[swizzles objectForKey:MAPTABLE_ID(aMethod)];
}
...
+ (void)setSwizzle:(FBSDKBetaSwizzle *)swizzle forMethod:(Method)aMethod
{
          ...
          @try {
            ...
            if (aMethod) {
              ...
              if (numArgs >= MIN_ARGS && numArgs <= MAX_ARGS) {
                BOOL isLocal = [FBSDKBetaSwizzler isLocallyDefinedMethod:aMethod onClass:aClass];
                ...
                FBSDKBetaSwizzle *swizzle = [FBSDKBetaSwizzler swizzleForMethod:aMethod];
                ...
                if (isLocal) {
                  if (!swizzle) {
                    ...
                    swizzle = [[FBSDKBetaSwizzle alloc] initWithBlock:aBlock named:aName forClass:aClass selector:aSelector originalMethod:originalMethod withNumArgs:numArgs];
                    [FBSDKBetaSwizzler setSwizzle:swizzle forMethod:aMethod];
                  } else {
                  ...
                  FBSDKBetaSwizzle *newSwizzle = [[FBSDKBetaSwizzle alloc] initWithBlock:aBlock named:aName forClass:aClass selector:aSelector originalMethod:originalMethod withNumArgs:numArgs];
                  [FBSDKBetaSwizzler setSwizzle:newSwizzle forMethod:newMethod];
                }
              }
            }
  ...
  @try {
    ...
    if (swizzle) {
      ...
      if (!aName || swizzle.blocks.count == 0) {
        ...
        [FBSDKBetaSwizzler removeSwizzleForMethod:aMethod];
      }
    }
  } @catch (NSException *exception) {
...
+ (void)swizzleSelectorWithBlock:(dispatch_block_t)block async:(BOOL)async
{
  if (async) {
    dispatch_async(swizzleQueue, block);
  } else {
    block();
  }
}
...
@implementation FBSDKBetaSwizzle
...
@implementation FBSDKBetaSwizzlingOnClass
