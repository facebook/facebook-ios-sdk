...
@interface FBInMemoryFBSessionTokenCachingStrategy()

@property (nonatomic, copy) NSDictionary *tokenInformation;

@end

@implementation FBInMemoryFBSessionTokenCachingStrategy
