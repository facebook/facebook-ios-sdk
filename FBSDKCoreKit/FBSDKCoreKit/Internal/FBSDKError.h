...
+ (NSError *)fbErrorWithCode:(NSInteger)code message:(nullable NSString *)message;
...
+ (NSError *)fbRequiredArgumentErrorWithName:(NSString *)name message:(nullable NSString *)message;
