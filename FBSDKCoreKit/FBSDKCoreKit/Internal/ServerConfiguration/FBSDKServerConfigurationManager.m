...
#define FBSDK_SERVER_CONFIGURATION_MONITORING_CONFIG_FIELD @"monitoring_config"
...
+ (void)processLoadRequestResponse:(id)result error:(NSError *)error appID:(NSString *)appID
{
  ...
  FBSDKMonitoringConfiguration *monitoringConfiguration = [FBSDKMonitoringConfiguration initWithDictionary:resultDictionary[FBSDK_SERVER_CONFIGURATION_MONITORING_CONFIG_FIELD]];
...
//                      FBSDK_SERVER_CONFIGURATION_MONITORING_CONFIG_FIELD
#if !TARGET_OS_TV
