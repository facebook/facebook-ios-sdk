...
static NSString *const _mockDefaultVersion = @"v3.3";
...
- (void)testSerializeURL
{
  ...
  NSString *url = [FBSDKGraphRequest serializeURL:baseURL
                                       ...
                                       httpMethod:FBSDKHTTPMethodPOST
                                         forBatch:YES];
  NSString *expectedURL = @"https://graph.facebook.com/v3.3/me?fields=";

  XCTAssertEqualObjects(url, expectedURL);

  // Test URLEncode and URLDecode
  NSString *expectedEncodedURL = @"https%3A%2F%2Fgraph.facebook.com%2Fv3.3%2Fme%3Ffields%3D";
