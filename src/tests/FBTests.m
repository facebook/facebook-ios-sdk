...
- (void)setUp {
    ...
    [[[self.mockFBUtility stub] andReturn:nil] advertiserOrAnonymousID:YES];  //also stub advertiserOrAnonymousID when it's going to access IDFA since that often hangs.
