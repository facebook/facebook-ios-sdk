...
@implementation FakeMonitorStore

- (void)persist:(NSArray<id<FBSDKMonitorEntry>> *)entries
{
  [super persist:entries];

  self.persistWasCalled = true;
  self.capturedPersistedEntries = entries;
}

- (NSArray<id<FBSDKMonitorEntry>> *)retrieveEntries
{
  self.retrieveEntriesWasCalled = true;
