...
FBSDK_EXTERN const char *fbsdkdfl_sqlite3_errmsg(sqlite3 *db);
FBSDK_EXTERN int fbsdkdfl_sqlite3_prepare_v2(sqlite3 *db, const char *zSql, int nByte, sqlite3_stmt **ppStmt, const char **pzTail);
FBSDK_EXTERN int fbsdkdfl_sqlite3_reset(sqlite3_stmt *pStmt);
FBSDK_EXTERN int fbsdkdfl_sqlite3_finalize(sqlite3_stmt *pStmt);
FBSDK_EXTERN int fbsdkdfl_sqlite3_open_v2(const char *filename, sqlite3 **ppDb, int flags, const char *zVfs);
FBSDK_EXTERN int fbsdkdfl_sqlite3_exec(sqlite3 *db, const char *sql, int (*callback)(void *, int, char **, char **), void *arg, char **errmsg);
FBSDK_EXTERN int fbsdkdfl_sqlite3_close(sqlite3 *db);
FBSDK_EXTERN int fbsdkdfl_sqlite3_bind_double(sqlite3_stmt *stmt, int index, double value);
FBSDK_EXTERN int fbsdkdfl_sqlite3_bind_int(sqlite3_stmt *stmt, int index, int value);
FBSDK_EXTERN int fbsdkdfl_sqlite3_bind_text(sqlite3_stmt *stmt, int index, const char *value, int n, void(*callback)(void *));
FBSDK_EXTERN int fbsdkdfl_sqlite3_step(sqlite3_stmt *stmt);
FBSDK_EXTERN double fbsdkdfl_sqlite3_column_double(sqlite3_stmt *stmt, int iCol);
