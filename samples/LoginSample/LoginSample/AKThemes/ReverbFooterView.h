...
@protocol ReverbFooterViewDelegate;

@interface ReverbFooterView : UIView
...
@property (nonatomic, weak) id<ReverbFooterViewDelegate> delegate;

@end

@protocol ReverbFooterViewDelegate <NSObject>
