...
- (instancetype)initWithCoder:(NSCoder *)decoder
{
  ...
  NSSet<Class> *friendIDsClasses = [NSSet setWithObjects:NSArray.class, NSString.class, nil];
  NSArray<FBSDKUserIdentifier> *friendIDs = [decoder decodeObjectOfClasses:friendIDsClasses forKey:FBSDKProfileCodingKeyFriendIDs];
