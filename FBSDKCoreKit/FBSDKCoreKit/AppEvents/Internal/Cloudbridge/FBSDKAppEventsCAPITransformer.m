...
{
  static NSDictionary<NSString *, NSArray<NSString *> *> *topLevelTransformations = nil;
...
{
  static NSDictionary<NSString *, NSArray<NSString *> *> *customEventTransformations = nil;
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
...
+ (NSDictionary<NSString *, NSString *> *)standardEventTransformations
{
  static NSDictionary<NSString *, NSString *> *standardEventTransformations = nil;
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
  ...
  return standardEventTransformations;
}

+ (NSSet<NSString *> *)topLevelParametersToCopyWithoutTx
{
  static NSSet<NSString *> *topLevelParametersToCopyWithoutTx = nil;
  static dispatch_once_t onceToken;
  dispatch_once(
    &onceToken, ^{
      topLevelParametersToCopyWithoutTx = [NSSet setWithArray:@[
        DATA_PROCESSING_OPTIONS,
        DATA_PROCESSING_OPTIONS_COUNTRY,
        DATA_PROCESSING_OPTIONS_STATE,
                                           ]];
    });
  return topLevelParametersToCopyWithoutTx;
}
