...
class AEMEventParameterViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
  ...
  private let validationButton: UIButton = .init()
  private let generationButton: UIButton = .init()
  ...
  override func viewDidLoad() {
    ...
    validationButton.addTarget(
      self,
      action: #selector(AEMEventParameterViewController.validateParameter),
      for: .touchUpInside
    )
    ...
    generationButton.addTarget(
      self,
      action: #selector(AEMEventParameterViewController.generateParameter),
      for: .touchUpInside
    )
